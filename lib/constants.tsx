...
export const DAILY_BASIC_CONFIG: Quest[] = [
    { id: 'd1', title: '五感恩',   sub: '每日五感恩練習',                   reward: 200, icon: '🙏' },
    { id: 'd2', title: '餐前感恩', sub: '餐前感恩練習',                     reward: 200, icon: '🍽️' },
    { id: 'd3', title: '嗯啊吽',   sub: '嗯啊吽咒語練習',                   reward: 200, icon: '🔔' },
    { id: 'd4', title: '感恩冥想', sub: '感恩冥想練習',                     reward: 200, icon: '💛' },
    { id: 'd5', title: '抄經',     sub: '抄寫心經或指定經文',               reward: 200, icon: '📝' },
    { id: 'd6', title: '光的冥想', sub: '光的冥想練習',                     reward: 200, icon: '☀️' },
    { id: 'd7', title: '欣賞',     sub: '欣賞伴侶或身邊的人',               reward: 200, icon: '💑' },
    { id: 'd8', title: '活在當下', sub: '活在當下練習',                     reward: 200, icon: '🎯' },
];
...
export const DIET_QUEST_CONFIG: Quest[] = [
    { id: 'diet_veg',     title: '三餐吃素',   sub: '今日三餐全素',    reward: 500, icon: '🥦' },
    { id: 'diet_seafood', title: '三餐海鮮素', sub: '今日三餐海鮮素',  reward: 300, icon: '🌊' },
];
...
export const WEEKLY_QUEST_CONFIG: Quest[] = [
    ...
    { id: 'wk3_online',  title: '小組凝聚（線上）', sub: '線上小組聚會（學員自行提交，小隊長初審通過後入帳 +1000）', reward: 1000, limit: 1 },
