                    ...
                    {rows.map(r => (
                        <div key={r.label} className="group flex items-start gap-2 text-xs">
                            ...
                            <div className="flex-1 flex items-center justify-between gap-2">
                                ...
                                <span className="opacity-0 group-hover:opacity-100 text-[10px] font-black text-emerald-600 bg-emerald-50 border border-emerald-200 px-1.5 py-0.5 rounded-md whitespace-nowrap">
